...
class Modifier(db.Model):
    ...
    product: Mapped[list['Products']] = relationship('Products', secondary='product_modifiers', back_populates='modifier')
...
class User(db.Model):
    ...
    accounting_ledger: Mapped[list['AccountingLedger']] = relationship('AccountingLedger', back_populates='users')
    register_sessions_closed_by: Mapped[list['RegisterSessions']] = relationship('RegisterSessions', foreign_keys='[RegisterSessions.closed_by]', back_populates='users')
    register_sessions_opened_by: Mapped[list['RegisterSessions']] = relationship('RegisterSessions', foreign_keys='[RegisterSessions.opened_by]', back_populates='users_')
    cash_movements: Mapped[list['CashMovements']] = relationship('CashMovements', back_populates='users')
...
class Products(db.Model):
    ...
    modifier: Mapped[list['Modifier']] = relationship('Modifier', secondary='product_modifiers', back_populates='product')
    category: Mapped[Optional['Category']] = relationship('Category', back_populates='products')
    order_items: Mapped[list['OrderItems']] = relationship('OrderItems', back_populates='product')


class RegisterSessions(db.Model):
    ...
    cash_movements: Mapped[list['CashMovements']] = relationship('CashMovements', back_populates='register_session')
    orders: Mapped[list['Orders']] = relationship('Orders', back_populates='register_session')
    payments: Mapped[list['Payments']] = relationship('Payments', back_populates='register_session')


class CashMovements(db.Model):
    ...
    register_session: Mapped[Optional['RegisterSessions']] = relationship('RegisterSessions', back_populates='cash_movements')
...
class Orders(db.Model):
    ...
    register_session: Mapped[Optional['RegisterSessions']] = relationship('RegisterSessions', back_populates='orders')
...
class Payments(db.Model):
    ...
    register_session: Mapped[Optional['RegisterSessions']] = relationship('RegisterSessions', back_populates='payments')
...
class OrderItemModifier(db.Model):
    ...
    order_item: Mapped[Optional['OrderItems']] = relationship('OrderItems', back_populates='order_item_modifiers')
